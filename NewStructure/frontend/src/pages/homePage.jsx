    ...
    return (
        <div className="homePage">
            ...
            <div className="about-cirt">
                ...
                <p>CIRT is based out of the College of Social Sciences, Mathematics and Education (CSSME) and is linked to the Department of Criminology and Criminal Justice at The University of Tampa. The CIRT supports research and training between faculty, students and criminal justice agencies in an effort to improve policy and practice.</p>
            </div>



            <div className="cirt-function">
                <h2>CIRT Function</h2>
                ...
                <ol>
                    <li>Encourage networking and collaboration between UT scholars and criminal justice agencies and businesses;</li>
                    <li>Provide learning resources and training for students, faculty and criminal justice professionals;</li>
                    <li>Prepare students for future careers in the ever-changing field of criminal justice; and</li>
                    <li>Provide a central hub for the intersection of research, training and student engagement within the Department of Criminology and Criminal Justice.</li>
                </ol>
            </div>
        </div>
    );
